...
namespace Proyecto_Joel_AF
{
    public partial class frmClientes : Form
    {
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("DESEA ELEMINAR EL CLIENTE?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string Mensaje = string.Empty;
                    Cliente obj = new Cliente()
                    {
        ...
        private void btnexcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                saveFile.FileName = String.Format("RepórteCliente_ {0}.xlsx ", DateTime.Now.ToString("ddMMyyyyHHmmss"));
